...
from edit_handlers import (
    ...
    handle_anime_code  # 3 xonali kod orqali anime chiqarish
)
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("show_"):
        ...
        await update.message.reply_text(f"✏️ {field} uchun yangi qiymat kiriting:")
...
def main():
    ...
    app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, handle_anime_code))  # 3 xonali kod orqali anime chiqarish
